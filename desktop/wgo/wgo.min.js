!(function (t, i) {
  ...
  (o.themes = {}),
    (o.themes.old = {
      ...
      markupBlackColor: "rgba(100,255,255,0.8)",
  ...
  (o.prototype = {
    ...
    (o.default = {
      ...
      background: s.DIR + "board/wood_1024.jpg",
      whiteStoneGraphic: [s.DIR + "stones/white128.png"],
      blackStoneGraphic: [s.DIR + "stones/black_128.png"],
      theme: {},
    }),
    (s.Board = o);
  var w = function (t) {
